...
Edited 2018/10/09 by Joey Chatelain -- accommodate older guide frames (from May 2018)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--fr", help="Frame rate in ms/frame (Defaults to 100 ms/frame or 10 frames/second",
                        default=100, type=float)
    parser.add_argument("--ir", help="Frame rate in ms/frame for first 5 frames (Defaults to 1000 ms/frame or 1"
                                     " frames/second", default=1000, type=float)
